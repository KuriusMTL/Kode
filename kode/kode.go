...
func Run(code string) error {
	...
	scope := CreateFunction("main", []Argument{}, map[string]*Variable{"_DEBUG": &_debug, "_MAX_RECURSION": &_max_recursion}, "null", nil, strings.ReplaceAll(code, "\r", " "))

	// Enter the main scope.
	_, _, err := scope.Run([]*Variable{}, map[string]*Variable{}, 0)
